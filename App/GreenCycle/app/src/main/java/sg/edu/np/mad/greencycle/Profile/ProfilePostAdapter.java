...
import sg.edu.np.mad.greencycle.Forum.FullPostActivity;
import sg.edu.np.mad.greencycle.Forum.ImagePagerAdapter;
...
public class ProfilePostAdapter extends RecyclerView.Adapter<ProfilePostAdapter.PostViewHolder> {
    ...
    public ProfilePostAdapter(List<Post> postList, Context context, User user) {
